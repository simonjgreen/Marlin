...
// LCD Menu Messages
	...
	#define MSG_AUTO_HOME "Auto Home All"
	#define MSG_HOME_XY "Auto Home X&Y"
	#define MSG_HOME_Z "Auto Home Z"
	#define MSG_MARK_Z_ORIGIN "Define Z Origin"
	#define MSG_BED_PROBING "Auto Bed Leveling"
	#define MSG_CENTRE_HEAD "Centre X&Y"
